...
export class WorkflowWorkspaceManager {
  ...
  constructor(basePath: string = getWorkspaceDir()) {
  ...
  async listWorkspaces(): Promise<AppOptions[]> {
    try {
  ...
  async loadProjectConfig(appCode: string): Promise<ProjectConfig | null> {
    try {
  ...
  async createWorkspace(
    ...
    try {
      ...
      return {
        success: false,
        message: `Failed to create workflow workspace: ${(error as Error).message}`
      };
    }
  }

  async deleteWorkspace(code: string): Promise<FileOperationResult> {
    try {
      ...
      return {
        success: false,
        message: `Failed to delete workspace: ${(error as Error).message}`
      };
    }
  }

  async updateWorkspaceOptions(code: string, updates: Partial<AppOptions>): Promise<FileOperationResult> {
    try {
      ...
      const currentOptions = JSON.parse(currentOptionsContent) as AppOptions;
      ...
      return {
        success: false,
        message: `Failed to update workspace options: ${(error as Error).message}`
      };
    }
  }
  ...
  async updateArea(
    ...
    try {
      ...
      return {
        success: false,
        message: `Failed to update area: ${(error as Error).message}`
      };
    }
  }
  ...
  async updateSubArea(
    ...
    try {
      ...
      const subareaIndex = config.areas[areaIndex].subareas.findIndex(
        subarea => subarea.code === subareaCode
      );
      ...
      return {
        success: false,
        message: `Failed to update subarea: ${(error as Error).message}`
      };
    }
  }
  ...
  async updateProcess(
    ...
    try {
      ...
      if (subareaCode) {
        subareaIndex = config.areas[areaIndex].subareas.findIndex(
          subarea => subarea.code === subareaCode
        );
        ...
        processIndex = config.areas[areaIndex].subareas[subareaIndex].processes.findIndex(
          process => process.code === processCode
        );
      } else {
        processIndex = config.areas[areaIndex].processes.findIndex(
          process => process.code === processCode
        );
      }
      ...
      return {
        success: false,
        message: `Failed to update process: ${(error as Error).message}`
      };
    }
  }
  ...
  async addArea(
    ...
    try {
      ...
      return {
        success: false,
        message: `Failed to add area: ${(error as Error).message}`
      };
    }
  }
  ...
  async addSubArea(
    ...
    try {
      ...
      return {
        success: false,
        message: `Failed to add subarea: ${(error as Error).message}`
      };
    }
  }

  async addProcessDefinition(
    appCode: string,
    areaCode: string,
    processCode: string,
    title: string,
    ...
    try {
      ...
      return {
        success: false,
        message: `Failed to add process: ${(error as Error).message}`
      };
    }
  }

  async deleteArea(appCode: string, areaCode: string): Promise<FileOperationResult> {
    try {
      ...
      return {
        success: false,
        message: `Failed to delete area: ${(error as Error).message}`
      };
    }
  }
  ...
  async deleteSubArea(
    ...
    try {
      ...
      return {
        success: false,
        message: `Failed to delete subarea: ${(error as Error).message}`
      };
    }
  }
  ...
  async deleteProcess(
    ...
    try {
      ...
      return {
        success: false,
        message: `Failed to delete process: ${(error as Error).message}`
      };
    }
  }
}